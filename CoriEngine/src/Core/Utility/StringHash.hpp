...
[[nodiscard]] consteval Cori::Utils::StringHash32 operator""_hs32(const char* str, [[maybe_unused]] size_t len) {
	return entt::hashed_string(str).value();
}

[[nodiscard]] consteval Cori::Utils::StringHash64 operator""_hs64(const char* str, size_t len) {
	return Cori::Utils::fnv1a64(str, len);
}
