...
namespace Cori {
	...
	class OpenGLVertexBuffer final : public VertexBuffer, public Profiling::Trackable<OpenGLVertexBuffer, VertexBuffer>, public RegisterInFactory<VertexBuffer, OpenGLVertexBuffer, GraphicsAPIs, GraphicsAPIs::OpenGL> {
	public:
	...
	class OpenGLIndexBuffer final : public IndexBuffer, public Profiling::Trackable<OpenGLIndexBuffer, IndexBuffer>, public RegisterInFactory<IndexBuffer, OpenGLIndexBuffer, GraphicsAPIs, GraphicsAPIs::OpenGL, uint32_t*, uint32_t> {
	public:
