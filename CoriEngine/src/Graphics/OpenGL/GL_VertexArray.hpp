...
namespace Cori {
	...
	class OpenGLVertexArray final : public VertexArray, public Profiling::Trackable<OpenGLVertexArray, VertexArray>, public RegisterInFactory<VertexArray, OpenGLVertexArray, GraphicsAPIs, GraphicsAPIs::OpenGL> {
	public:
