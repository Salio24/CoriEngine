	...
	namespace Graphics {
		namespace Internal {
			OpenGLShaderProgram::OpenGLShaderProgram(const std::filesystem::path& vertexPath, const std::filesystem::path& fragmentPath, const std::filesystem::path& geometryPath) {
				...
				const std::string vertexCode = FileSystem::FileManager::ReadTextFile(vertexPath);
				const char* vertexSource = vertexCode.c_str();


				const std::string fragmentCode = FileSystem::FileManager::ReadTextFile(fragmentPath);
				...
				if (geometryShaderPresent) {
					...
					const std::string geometryCode = FileSystem::FileManager::ReadTextFile(geometryPath);
